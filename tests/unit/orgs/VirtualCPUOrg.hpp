...
TEST_CASE("VirtualCPUOrg_Main", "[orgs]"){
  ...
  tmp_org.SharedData().inst_set_input_filename = "orgs/inst_set_test.txt";
  ...
  { // ManagerData
    ...
    CHECK(org_a.SharedData().genome_trait.GetName() == "genome");
    org_a.SharedData().offspring_merit_trait.SetName("child_merit_2");
    CHECK(org_a.SharedData().offspring_merit_trait.GetName() == "child_merit_2");
    ...
    CHECK(org_b.SharedData().offspring_merit_trait.GetName() == "child_merit_2");
  ...
  {// CloneOrganism 
    ...
    emp::String child_genome =child_org->GetGenomeString();
