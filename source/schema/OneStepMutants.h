...
namespace mabe {
  ...
  public:
    ...
    void SetupConfig() override {
      ...
      // Add generate() function to this module's scope
      std::function<int()> gen_func =
        [this]() {
          Generate();
          return 0;
        };
      GetScope().AddFunction("generate", gen_func,
        "Generate the specifed one-step mutants.");
    }
    ...
    void Generate(){
      ...
      control.DoBirth(org, source_pop.begin().AsPosition(), mutant_pop, num_mutants, false);
