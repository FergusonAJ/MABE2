...
#ifndef MABE_EVAL_TEST_H
#define MABE_EVAL_TEST_H
...
namespace mabe {
  ...
  public:
    EvalTest(mabe::MABE & control,
           const std::string & name="EvalTest",
    ...
    void OnUpdate(size_t update) override {
      ...
      //std::cout << "target_collect: " << target_collect.ToString() << std::endl;
      //std::cout << "size of this ^ pop: " << target_collect.GetFirstPop()->GetSize() << std::endl;
  ...
  MABE_REGISTER_MODULE(EvalTest, "Evaluate bitstrings on an NK fitness lanscape. (test)");
}
